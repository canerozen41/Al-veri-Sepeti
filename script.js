...
// Product class to handle fetching products
class Product {
    async getProducts() {
        try {
            let result = await fetch("https://66abcb35f009b9d5c7305a89.mockapi.io/products");
...
// Storage class to handle local storage
class Storage {
